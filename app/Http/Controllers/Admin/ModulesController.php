...
class ModulesController extends Controller
{
    ...
    public function create()
    {
        ...
        $projectids = ManageProject::all()->pluck('project', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.modules.create', compact('projectids'));
    }
    ...
    public function edit(Module $module)
    {
        ...
        $module->load('projectid', 'created_by', 'updated_by');

        return view('admin.modules.edit', compact('projectids', 'module'));
    }
