...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Manage Projects
    Route::delete('manage-projects/destroy', 'ManageProjectsController@massDestroy')->name('manage-projects.massDestroy');
    Route::resource('manage-projects', 'ManageProjectsController');
